...
DROP TABLE EM_MEDICAMENTOS_USUARIOS;
...
CREATE TABLE EM_MEDICAMENTOS_USUARIOS (
	CODIGO_MEDICAMENTO_USUARIO NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
	CODIGO_MEDICAMENTO NUMBER NOT NULL,
	CODIGO_USUARIO NUMBER NOT NULL, 

	constraint PK_MEDICAMENTOS_USUARIOS PRIMARY KEY (CODIGO_MEDICAMENTO_USUARIO)
);
...
CREATE TABLE EM_MEDICAMENTO_USUARIO_INTERVALO (
	...
	CODIGO_MEDICAMENTO_USUARIO NUMBER NOT NULL, 
	DATA_INICIO DATE NOT NULL,
	DATA_FINAL DATE,
	INTERVALO_HORAS NUMBER NOT NULL,
	MEDICAMENTO_ATIVO NUMBER(1) DEFAULT 1 NOT NULL,

	constraint PK_MEDICAMENTO_HORARIO PRIMARY KEY (CODIGO_MEDICAMENTO_USUARIO_INTERVALO)
);
...
ALTER TABLE EM_MEDICAMENTOS_USUARIOS ADD CONSTRAINT FK_USUARIO_MEDICAMENTO FOREIGN KEY (CODIGO_USUARIO) REFERENCES EM_USUARIOS(CODIGO_USUARIO);
ALTER TABLE EM_MEDICAMENTOS_USUARIOS ADD CONSTRAINT FK_MEDICAMENTO_USUARIO FOREIGN KEY (CODIGO_MEDICAMENTO) REFERENCES EM_MEDICAMENTOS(CODIGO_MEDICAMENTO);
ALTER TABLE EM_MEDICAMENTO_USUARIO_INTERVALO ADD CONSTRAINT FK_USUARIO_MEDICAMENTO_INTERVALO FOREIGN KEY (CODIGO_MEDICAMENTO_USUARIO_INTERVALO) REFERENCES EM_MEDICAMENTOS_USUARIOS(CODIGO_MEDICAMENTO_USUARIO);
