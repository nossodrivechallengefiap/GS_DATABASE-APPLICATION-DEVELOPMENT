...
ALTER TABLE EASYMED_USUARIOS ADD CONSTRAINT FK_EASYMED_USUARIO_TIPO_USUARIO FOREIGN KEY (CODIGO_TIPO_USUARIO) REFERENCES EASYMED_TIPO_USUARIO(CODIGO_TIPO_USUARIO);
ALTER TABLE EASYMED_PESSOA_FISICA ADD CONSTRAINT FK_EASYMED_PESSOA_FISICA_USUARIO FOREIGN KEY (CODIGO_USUARIO) REFERENCES EASYMED_USUARIOS(CODIGO_USUARIO);
ALTER TABLE EASYMED_PESSOA_JURIDICA ADD CONSTRAINT FK_EASYMED_PESSOA_JURIDICA_USUARIO FOREIGN KEY (CODIGO_USUARIO) REFERENCES EASYMED_USUARIOS(CODIGO_USUARIO);
ALTER TABLE EASYMED_TRATAMENTOS ADD CONSTRAINT FK_EASYMED_TRATAMENTO_USUARIO FOREIGN KEY (CODIGO_USUARIO) REFERENCES EASYMED_USUARIOS(CODIGO_USUARIO);
ALTER TABLE EASYMED_TRATAMENTOS ADD CONSTRAINT FK_EASYMED_TRATAMENTO_MEDICAMENTO FOREIGN KEY (CODIGO_MEDICAMENTO) REFERENCES EASYMED_MEDICAMENTOS(CODIGO_MEDICAMENTO);
/
