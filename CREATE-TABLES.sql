...
-- Criando procedures para insert 
-- Criando blocos para insert 
DECLARE
	P_SENHA VARCHAR2(255);
...
CREATE OR REPLACE PROCEDURE INSERT_EM_USUARIOS (
  P_SENHA VARCHAR2,
  P_EMAIL VARCHAR2
)
AS
...
BEGIN
  ...
  INSERT INTO EM_USUARIOS (SENHA, EMAIL)
  VALUES (P_SENHA, P_EMAIL);
END INSERT_EM_USUARIOS;
/

CREATE OR REPLACE PROCEDURE INSERT_EM_PESSOA_FISICA (
...
END INSERT_EM_PESSOA_FISICA;
/

CREATE OR REPLACE PROCEDURE INSERT_EM_PESSOA_JURIDICA (
	P_CODIGO_USUARIO NUMBER,
...
END INSERT_EM_PESSOA_JURIDICA;
/

CREATE OR REPLACE PROCEDURE INSERT_EM_TIPO_USUARIO (
	P_CODIGO_USUARIO NUMBER,
...
CREATE OR REPLACE PROCEDURE INSERT_EM_MEDICAMENTOS (
	P_NOME_MEDICAMENTO VARCHAR2
)
AS
	COUNT_LINES NUMBER;
BEGIN
...
CREATE OR REPLACE PROCEDURE INSERT_EM_MEDICAMENTO_LIQUIDO (
	P_CODIGO_MEDICAMENTO NUMBER,
	P_VOLUME_ML NUMBER
)
AS
	COUNT_LINES NUMBER;
...
END INSERT_EM_MEDICAMENTO_LIQUIDO;
/

CREATE OR REPLACE PROCEDURE INSERT_EM_MEDICAMENTO_SOLIDO (
	P_CODIGO_MEDICAMENTO NUMBER,
	P_QUANTIDADE NUMBER
)
AS
...
END INSERT_EM_MEDICAMENTO_SOLIDO;
/

CREATE OR REPLACE PROCEDURE INSERT_EM_MEDICAMENTO_USUARIO_INTERVALO (
	P_CODIGO_MEDICAMENTO NUMBER,
	P_CODIGO_USUARIO NUMBER,
	P_DATA_INICIO DATE,
	P_DATA_FINAL DATE,
	P_INTERVALO_HORAS NUMBER,
	P_MEDICAMENTO_ATIVO NUMBER
)
AS
	COUNT_LINES NUMBER;
BEGIN
